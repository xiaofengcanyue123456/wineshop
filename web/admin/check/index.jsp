...
<script type="text/html" id="barDemo">
   ...
   <%-- <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delete">删除</a>--%>
    ...
    <a class="layui-btn layui-btn-xs layui-btn-warm" lay-event="query">退房详情</a>
<%--    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delete">删除</a>--%>
    {{#}}}
    </script>
...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.on('tool(test)', function (obj) {
            ...
            if (obj.event === 'edit') {  // 监听添加操作
            ...
            } else if (obj.event === 'query') {  // 监听详细信息
                localStorage.removeItem("outId");
                localStorage.setItem("outId",data.outId);
                debugger
                var index = layer.open({
                    title: '退房详细',
                    type: 2,
                    ...
                    shadeClose: true,
                    area: ['30%', '40%'],
                    content: '<%=basePath%>admin/check/query.jsp',
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
                ...
                //     //调用删除功能
                //     deleteInfoByIds(data.outId,index);
                //     console.log(data)
                //     debugger
                //     layer.close(index);
                // });
